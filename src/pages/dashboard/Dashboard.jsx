...
export default function Dashboard() {
      ...
      <div className="min-h-full">
        ...
        <header className="bg-white shadow">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900">My Financial Dashboard </h1>
          </div>
        </header>
        <main>
  ...
  <div className="max-w-sm w-full bg-white rounded-lg shadow center dark:bg-gray-800 p-4 md:p-6">
